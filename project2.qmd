...
```{r}
mobile_device_data <-mutate(mobile_device_data,across(c(
  user_id, device_model, operating_system, app_usage_time, screen_on_time, battery_drain, num_app_installed, data_usage, age, gender, user_behavior_class)))
```
